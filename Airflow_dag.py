...
GLUE_PREFIX = 'processed-data/spotify_clean_data.csv/'
...
def load_to_snowflake():
    try:
        ...
        try:
            ...
            # Step 3: Copy new data from external stage
            cs.execute("""
            ...
            # Step 4: Run SELECT * to verify
            cs.execute("SELECT * FROM spotify_data;")
            result = cs.fetchall()
            for row in result:
                print(row)

            print("✅ Snowflake data load completed.")
