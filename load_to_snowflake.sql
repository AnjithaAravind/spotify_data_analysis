...
STORAGE_ALLOWED_LOCATIONS = ('s3://ec2gluebucket/processed-data/spotify_clean_data.csv/');

DESC INTEGRATION s3_spotifyglue;

CREATE OR REPLACE STAGE glue_stage
  URL = 's3://ec2gluebucket/processed-data/spotify_clean_data.csv/'
...
SET STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::659376306968:role/glue_snowflake';
